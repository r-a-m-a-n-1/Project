...
const ProfessionalEthicsLectureNotes = () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Professional Ethics"; // <-- CHANGE THIS to your subject
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white min-h-screen">
      <div className="sticky top-0 z-50 w-full bg-black bg-opacity-90 backdrop-blur-sm py-4">
       ...
       Professional Ethics Lecture Notes {/* Change title here too */}
        </h1>
      </div>
...
export default ProfessionalEthicsLectureNotes;
