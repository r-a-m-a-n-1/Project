...
const TechnicalCommunicationLectureNotes = () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Technical Communication Skills"; // <-- CHANGE THIS to your subject
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white min-h-screen">
      ...
      Technical Communication Skills Lecture Notes {/* Change title here too */}
        </h1>
      </div>
...
export default TechnicalCommunicationLectureNotes;
