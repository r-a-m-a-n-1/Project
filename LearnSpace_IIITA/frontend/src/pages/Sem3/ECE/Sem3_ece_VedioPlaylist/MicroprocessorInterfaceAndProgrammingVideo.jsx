...
const MicroprocessorInterfaceAndProgrammingVideoPage = () => {
  const videoIDs = [
  ...
  return (
    <div className="bg-black text-white w-full min-h-screen p-8">
      <h1 className="text-4xl font-bold text-center mb-8">
        Microprocessor Interface And Programming Video
      </h1>
...
export default MicroprocessorInterfaceAndProgrammingVideoPage;
