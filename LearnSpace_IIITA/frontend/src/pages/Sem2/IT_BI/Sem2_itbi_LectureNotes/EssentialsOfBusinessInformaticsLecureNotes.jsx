...
const EssentialsOfBusinessInformaticsLectureNotes= () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Essentials Of Business Informatics";
 ...
 Essentials Of Business Informatics Lecture Notes
        </h1>
      </div>
...
export default EssentialsOfBusinessInformaticsLectureNotes;
