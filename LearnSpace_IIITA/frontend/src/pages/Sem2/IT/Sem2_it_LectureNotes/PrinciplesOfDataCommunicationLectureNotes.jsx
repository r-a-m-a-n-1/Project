...
const PrinciplesOfDataCommunicationLectureNotes= () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Principles Of Data Communication";
  ...
  return (
    ...
    Principles Of Data Communication Lecture Notes
        </h1>
      </div>
...
export default PrinciplesOfDataCommunicationLectureNotes;
