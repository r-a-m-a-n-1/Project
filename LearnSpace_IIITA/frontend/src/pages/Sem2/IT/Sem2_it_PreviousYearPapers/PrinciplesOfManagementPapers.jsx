...
import PrinciplesOfManagementPapersPage from "../../ECE/Sem2_ece_PreviousYearPapers/PrinciplesOfManagementPapers";

const  PrinciplesOfManagementPapersPage = () => {
  ...
  useEffect(() => {
    const fetchPapers = async () => {
      try {
        ...
        const subject = "Principles Of Management Papers";
    ...
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white min-h-screen">
      <div className="sticky top-0 z-50 w-full bg-black bg-opacity-90 backdrop-blur-sm py-4">
        <h1 className="text-3xl font-bold text-center">
          Principles Of Management Papers 
        </h1>
      </div>
...
export default PrinciplesOfManagementPapersPage;
