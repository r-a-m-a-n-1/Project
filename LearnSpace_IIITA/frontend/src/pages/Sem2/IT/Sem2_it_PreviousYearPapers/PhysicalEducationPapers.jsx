...
import PhyscialEducationPapersPage from "../../ECE/Sem2_ece_PreviousYearPapers/PhysicalEducationPapers";

const   PhyscialEducationPapersPage = () => {
  ...
  useEffect(() => {
    const fetchPapers = async () => {
      try {
        ...
        const subject = "Physcial Education";
...
export default PhyscialEducationPapersPage;
