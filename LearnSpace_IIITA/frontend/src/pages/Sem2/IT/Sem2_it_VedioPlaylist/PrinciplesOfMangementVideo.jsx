...
import PrinciplesOfManagementVideoPage from "../../ECE/Sem2_ece_VedioPlaylist/PrinciplesOfManagementVideo";

const PrinciplesOfManagementVideoPage = () => {
  const videoIDs = [
  ...
  return (
    <div className="bg-black text-white w-full min-h-screen p-8">
      <h1 className="text-4xl font-bold text-center mb-8">
        Principles Of Management Video
      </h1>
...
export default PrinciplesOfManagementVideoPage;
