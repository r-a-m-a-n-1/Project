...
const  ElectronicsMeasurementsAndInstrumentationsPapersPage = () => {
  ...
  return (
   ...
   Electronics Measurements And Instrumentations Papers
        </h1>
      </div>
...
export default ElectronicsMeasurementsAndInstrumentationsPapersPage;
