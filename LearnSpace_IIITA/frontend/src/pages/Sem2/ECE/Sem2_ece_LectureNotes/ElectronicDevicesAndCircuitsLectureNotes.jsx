...
const ElectronicDevicesAndCircuitsLectureNotes = () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Electronic Devices And Circuits";
  ...
  return (
    ...
    Electronic Devices And Circuits Lecture Notes
        </h1>
      </div>
...
export default ElectronicDevicesAndCircuitsLectureNotes;
