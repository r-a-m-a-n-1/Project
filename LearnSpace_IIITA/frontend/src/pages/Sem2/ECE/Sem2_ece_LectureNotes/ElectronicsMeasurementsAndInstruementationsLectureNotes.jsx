...
const ElectronicsMeasurementsAndInstrumentationsLectureNotes = () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Electronics Measurements And Instrumentations";
  ...
  Electronics Measurements And Instrumentations LectureNotes
        </h1>
      </div>
...
export default ElectronicsMeasurementsAndInstrumentationsLectureNotes;
