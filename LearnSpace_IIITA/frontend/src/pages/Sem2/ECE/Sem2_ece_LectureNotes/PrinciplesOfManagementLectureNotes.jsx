...
const PrinciplesOfMangementLectureNotes = () => {
  ...
  useEffect(() => {
    const fetchNotes = async () => {
      try {
        ...
        const subject = "Principles of Management";
...
Principles Of Mangement Lecture Notes
        </h1>
      </div>
...
export default PrinciplesOfMangementLectureNotes;
